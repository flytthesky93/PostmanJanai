...
func IsActive(v bool) predicate.Environment {
	return predicate.Environment(sql.FieldEQ(FieldIsActive, v))
}
...
func IsActiveEQ(v bool) predicate.Environment {
	return predicate.Environment(sql.FieldEQ(FieldIsActive, v))
}

// IsActiveNEQ applies the NEQ predicate on the "is_active" field.
func IsActiveNEQ(v bool) predicate.Environment {
	return predicate.Environment(sql.FieldNEQ(FieldIsActive, v))
}
...
// HasEnvironmentVariables applies the HasEdge predicate on the "environment_variables" edge.
func HasEnvironmentVariables() predicate.Environment {
...
// HasEnvironmentVariablesWith applies the HasEdge predicate on the "environment_variables" edge with a given conditions (other predicates).
func HasEnvironmentVariablesWith(preds ...predicate.EnvironmentVariable) predicate.Environment {
	return predicate.Environment(func(s *sql.Selector) {
		step := newEnvironmentVariablesStep()
