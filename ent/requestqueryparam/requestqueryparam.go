...
const (
	// Label holds the string label denoting the requestqueryparam type in the database.
	Label = "request_query_param"
	...
	EdgeRequest = "request"
	// Table holds the table name of the requestqueryparam in the database.
	Table = "request_query_params"
	// RequestTable is the table that holds the request relation/edge.
	RequestTable = "request_query_params"
...
// Columns holds all SQL columns for requestqueryparam fields.
var Columns = []string{
	FieldID,
	FieldRequestID,
	FieldKey,
...
// OrderOption defines the ordering options for the RequestQueryParam queries.
